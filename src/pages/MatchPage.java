...
/**
 * The MatchPage class represents a GUI window for displaying a match page in a
 * game.
 * It allows interaction with the game environment and provides information
 * about the opponent team and match rewards.
 */
public class MatchPage {
	...
	private void initialize() {
		...
		for (Athlete playerAthlete : playerAthletes) {
			...
			playerSFStats
					.add((playerAthlete.getOffence() + playerAthlete.getAgility() + playerAthlete.getDefence()) / 3);
		...
		btnFinishButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				environment.getGame().getTeam().decreaseAllStamina(); // decreases team stamina for every match they
																		// enter
		...
		gl_centerVersusPanel_1.setHorizontalGroup(
				gl_centerVersusPanel_1.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_centerVersusPanel_1.createSequentialGroup()
								.addComponent(playerCenterLabel_1, GroupLayout.PREFERRED_SIZE, 149,
										GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(ComponentPlacement.UNRELATED)
								.addComponent(centerVersusLabel_1, GroupLayout.PREFERRED_SIZE, 38,
										GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(ComponentPlacement.UNRELATED)
				...
				gl_centerVersusPanel_1.createParallelGroup(Alignment.TRAILING)
						...
						.addGroup(gl_centerVersusPanel_1.createSequentialGroup()
								...
								.addGroup(gl_centerVersusPanel_1.createParallelGroup(Alignment.BASELINE)
										.addComponent(playerCenterLabel_1, GroupLayout.DEFAULT_SIZE, 39,
												Short.MAX_VALUE)
										.addComponent(centerVersusLabel_1, GroupLayout.DEFAULT_SIZE, 38,
												Short.MAX_VALUE)
										.addComponent(oppCenterLabel_1, GroupLayout.DEFAULT_SIZE, 34,
												Short.MAX_VALUE))));
				...
				gl_centerPositionPanel_1.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_centerPositionPanel_1.createSequentialGroup()
								.addGroup(gl_centerPositionPanel_1.createParallelGroup(Alignment.TRAILING, false)
										.addGroup(gl_centerPositionPanel_1.createSequentialGroup()
												.addComponent(centerVersusPanel_1, GroupLayout.PREFERRED_SIZE, 346,
														GroupLayout.PREFERRED_SIZE)
												.addGap(8))
										.addGroup(gl_centerPositionPanel_1.createSequentialGroup()
						...
						.addGroup(gl_centerPositionPanel_1.createSequentialGroup()
								.addGroup(gl_centerPositionPanel_1.createParallelGroup(Alignment.LEADING)
										.addGroup(gl_centerPositionPanel_1.createSequentialGroup()
												...
												.addComponent(smallForwardLabel)
												.addPreferredGap(ComponentPlacement.RELATED)
												.addComponent(centerVersusPanel_1, GroupLayout.PREFERRED_SIZE, 38,
														Short.MAX_VALUE))
										.addComponent(sfScoreLabel, GroupLayout.PREFERRED_SIZE, 64,
												GroupLayout.PREFERRED_SIZE))
								.addContainerGap()));
		...
		gl_centerVersusPanel_2.setHorizontalGroup(
				gl_centerVersusPanel_2.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_centerVersusPanel_2.createSequentialGroup()
								.addComponent(playerCenterLabel_2, GroupLayout.PREFERRED_SIZE, 149,
										GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(ComponentPlacement.UNRELATED)
								.addComponent(centerVersusLabel_2, GroupLayout.PREFERRED_SIZE, 38,
										GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(ComponentPlacement.UNRELATED)
				...
				gl_centerVersusPanel_2.createParallelGroup(Alignment.TRAILING)
						...
						.addGroup(gl_centerVersusPanel_2.createSequentialGroup()
								...
								.addGroup(gl_centerVersusPanel_2.createParallelGroup(Alignment.BASELINE)
										.addComponent(playerCenterLabel_2, GroupLayout.DEFAULT_SIZE, 39,
												Short.MAX_VALUE)
										.addComponent(centerVersusLabel_2, GroupLayout.DEFAULT_SIZE, 38,
												Short.MAX_VALUE)
										.addComponent(oppCenterLabel_2, GroupLayout.DEFAULT_SIZE, 34,
												Short.MAX_VALUE))));
				...
				gl_centerPositionPanel_2.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_centerPositionPanel_2.createSequentialGroup()
								.addGroup(gl_centerPositionPanel_2.createParallelGroup(Alignment.TRAILING, false)
										.addGroup(gl_centerPositionPanel_2.createSequentialGroup()
												.addComponent(centerVersusPanel_2, GroupLayout.PREFERRED_SIZE, 346,
														GroupLayout.PREFERRED_SIZE)
												.addGap(8))
										.addGroup(gl_centerPositionPanel_2.createSequentialGroup()
						...
						.addGroup(gl_centerPositionPanel_2.createSequentialGroup()
								.addGroup(gl_centerPositionPanel_2.createParallelGroup(Alignment.LEADING)
										.addGroup(gl_centerPositionPanel_2.createSequentialGroup()
												...
												.addComponent(powerForwardLabel)
												.addPreferredGap(ComponentPlacement.RELATED)
												.addComponent(centerVersusPanel_2, GroupLayout.PREFERRED_SIZE, 38,
														Short.MAX_VALUE))
										.addComponent(pfScoreLabel, GroupLayout.PREFERRED_SIZE, 64,
												GroupLayout.PREFERRED_SIZE))
								.addContainerGap()));
		...
		gl_centerVersusPanel_3.setHorizontalGroup(
				gl_centerVersusPanel_3.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_centerVersusPanel_3.createSequentialGroup()
								.addComponent(playerCenterLabel_3, GroupLayout.PREFERRED_SIZE, 149,
										GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(ComponentPlacement.UNRELATED)
								.addComponent(centerVersusLabel_3, GroupLayout.PREFERRED_SIZE, 38,
										GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(ComponentPlacement.UNRELATED)
				...
				gl_centerVersusPanel_3.createParallelGroup(Alignment.TRAILING)
						...
						.addGroup(gl_centerVersusPanel_3.createSequentialGroup()
								...
								.addGroup(gl_centerVersusPanel_3.createParallelGroup(Alignment.BASELINE)
										.addComponent(playerCenterLabel_3, GroupLayout.DEFAULT_SIZE, 39,
												Short.MAX_VALUE)
										.addComponent(centerVersusLabel_3, GroupLayout.DEFAULT_SIZE, 38,
												Short.MAX_VALUE)
										.addComponent(oppCenterLabel_3, GroupLayout.DEFAULT_SIZE, 34,
												Short.MAX_VALUE))));
				...
				gl_centerPositionPanel_3.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_centerPositionPanel_3.createSequentialGroup()
								.addGroup(gl_centerPositionPanel_3.createParallelGroup(Alignment.TRAILING, false)
										.addGroup(gl_centerPositionPanel_3.createSequentialGroup()
												.addComponent(centerVersusPanel_3, GroupLayout.PREFERRED_SIZE, 346,
														GroupLayout.PREFERRED_SIZE)
												.addGap(8))
										.addGroup(gl_centerPositionPanel_3.createSequentialGroup()
						...
						.addGroup(gl_centerPositionPanel_3.createSequentialGroup()
								.addGroup(gl_centerPositionPanel_3.createParallelGroup(Alignment.LEADING)
										.addGroup(gl_centerPositionPanel_3.createSequentialGroup()
												...
												.addComponent(pointGuardLabel)
												.addPreferredGap(ComponentPlacement.RELATED)
												.addComponent(centerVersusPanel_3, GroupLayout.PREFERRED_SIZE, 38,
														Short.MAX_VALUE))
										.addComponent(pgScoreLabel, GroupLayout.PREFERRED_SIZE, 64,
												GroupLayout.PREFERRED_SIZE))
								.addContainerGap()));
		...
		gl_centerVersusPanel_4.setHorizontalGroup(
				gl_centerVersusPanel_4.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_centerVersusPanel_4.createSequentialGroup()
								.addComponent(playerCenterLabel_4, GroupLayout.PREFERRED_SIZE, 149,
										GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(ComponentPlacement.UNRELATED)
								.addComponent(centerVersusLabel_4, GroupLayout.PREFERRED_SIZE, 38,
										GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(ComponentPlacement.UNRELATED)
				...
				gl_centerVersusPanel_4.createParallelGroup(Alignment.TRAILING)
						...
						.addGroup(gl_centerVersusPanel_4.createSequentialGroup()
								...
								.addGroup(gl_centerVersusPanel_4.createParallelGroup(Alignment.BASELINE)
										.addComponent(playerCenterLabel_4, GroupLayout.DEFAULT_SIZE, 39,
												Short.MAX_VALUE)
										.addComponent(centerVersusLabel_4, GroupLayout.DEFAULT_SIZE, 38,
												Short.MAX_VALUE)
										.addComponent(oppCenterLabel_4, GroupLayout.DEFAULT_SIZE, 34,
												Short.MAX_VALUE))));
				...
				gl_centerPositionPanel_4.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_centerPositionPanel_4.createSequentialGroup()
								.addGroup(gl_centerPositionPanel_4.createParallelGroup(Alignment.TRAILING, false)
										.addGroup(gl_centerPositionPanel_4.createSequentialGroup()
												.addComponent(centerVersusPanel_4, GroupLayout.PREFERRED_SIZE, 346,
														GroupLayout.PREFERRED_SIZE)
												.addGap(8))
										.addGroup(gl_centerPositionPanel_4.createSequentialGroup()
						...
						.addGroup(gl_centerPositionPanel_4.createSequentialGroup()
								.addGroup(gl_centerPositionPanel_4.createParallelGroup(Alignment.LEADING)
										.addGroup(gl_centerPositionPanel_4.createSequentialGroup()
												...
												.addComponent(shootingGuardLabel)
												.addPreferredGap(ComponentPlacement.RELATED)
												.addComponent(centerVersusPanel_4, GroupLayout.PREFERRED_SIZE, 38,
														Short.MAX_VALUE))
										.addComponent(sgScoreLabel, GroupLayout.PREFERRED_SIZE, 64,
												GroupLayout.PREFERRED_SIZE))
								.addContainerGap()));
				...
				gl_scoreBoardPanel.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_scoreBoardPanel.createSequentialGroup()
								.addGroup(gl_scoreBoardPanel.createParallelGroup(Alignment.LEADING)
										.addComponent(teamNameLabel_1, GroupLayout.PREFERRED_SIZE, 129,
												GroupLayout.PREFERRED_SIZE)
										.addGroup(gl_scoreBoardPanel.createSequentialGroup()
												.addGroup(gl_scoreBoardPanel.createParallelGroup(Alignment.LEADING)
														.addGroup(gl_scoreBoardPanel.createSequentialGroup()
																.addContainerGap()
																.addComponent(teamNameLabel_2,
												...
												.addGroup(gl_scoreBoardPanel
														...
														.addGroup(gl_scoreBoardPanel.createSequentialGroup()
																...
																.addComponent(opponentScoreLabel,
						...
						.addGroup(gl_scoreBoardPanel.createSequentialGroup()
								.addGroup(gl_scoreBoardPanel.createParallelGroup(Alignment.LEADING)
										...
										.addGroup(gl_scoreBoardPanel.createParallelGroup(Alignment.BASELINE)
												.addComponent(scoreBoardLabel)
												.addComponent(opponentTeamNameLabel_1, GroupLayout.PREFERRED_SIZE, 20,
														GroupLayout.PREFERRED_SIZE)
												.addComponent(teamNameLabel_2, GroupLayout.PREFERRED_SIZE, 29,
														GroupLayout.PREFERRED_SIZE)))
								.addPreferredGap(ComponentPlacement.RELATED)
								.addGroup(gl_scoreBoardPanel.createParallelGroup(Alignment.LEADING)
										.addGroup(gl_scoreBoardPanel.createParallelGroup(Alignment.BASELINE)
												.addComponent(playerScoreLabel, GroupLayout.DEFAULT_SIZE, 22,
														Short.MAX_VALUE)
												.addComponent(lblNewLabel_3))
										.addComponent(opponentScoreLabel, GroupLayout.DEFAULT_SIZE, 22,
												Short.MAX_VALUE))
								.addContainerGap()));
						...
						.addGroup(groupLayout.createSequentialGroup()
								.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
										.addGroup(Alignment.TRAILING, groupLayout.createSequentialGroup()
												.addContainerGap()
												.addComponent(teamNamespanel, GroupLayout.PREFERRED_SIZE, 414,
														GroupLayout.PREFERRED_SIZE))
										.addGroup(Alignment.TRAILING, groupLayout.createSequentialGroup()
												.addContainerGap()
												.addComponent(centerPositionPanel, GroupLayout.DEFAULT_SIZE,
														GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
										.addGroup(Alignment.TRAILING, groupLayout.createSequentialGroup()
												.addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
												.addComponent(centerPositionPanel_1, GroupLayout.PREFERRED_SIZE, 414,
														GroupLayout.PREFERRED_SIZE))
										.addGroup(Alignment.TRAILING, groupLayout.createSequentialGroup()
												.addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
												.addComponent(centerPositionPanel_2, GroupLayout.PREFERRED_SIZE, 414,
														GroupLayout.PREFERRED_SIZE))
										.addGroup(Alignment.TRAILING, groupLayout.createSequentialGroup()
												.addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
												.addComponent(centerPositionPanel_3, GroupLayout.PREFERRED_SIZE, 414,
														GroupLayout.PREFERRED_SIZE))
										.addGroup(groupLayout.createSequentialGroup()
												.addContainerGap()
												.addComponent(centerPositionPanel_4, GroupLayout.PREFERRED_SIZE, 414,
														GroupLayout.PREFERRED_SIZE))
										.addGroup(groupLayout.createSequentialGroup()
												.addContainerGap()
												.addComponent(scoreBoardPanel, GroupLayout.PREFERRED_SIZE, 414,
														GroupLayout.PREFERRED_SIZE))
										.addGroup(groupLayout.createSequentialGroup()
												.addGap(143)
												.addComponent(btnFinishButton, GroupLayout.PREFERRED_SIZE, 145,
														GroupLayout.PREFERRED_SIZE)))
								.addContainerGap()));
		groupLayout.setVerticalGroup(
				groupLayout.createParallelGroup(Alignment.LEADING)
						.addGroup(groupLayout.createSequentialGroup()
								.addContainerGap()
								.addComponent(teamNamespanel, GroupLayout.PREFERRED_SIZE, 86,
										GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(ComponentPlacement.RELATED)
								.addComponent(centerPositionPanel, GroupLayout.PREFERRED_SIZE, 66,
										GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(ComponentPlacement.RELATED)
								.addComponent(centerPositionPanel_1, GroupLayout.PREFERRED_SIZE, 66,
										GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(ComponentPlacement.RELATED)
								.addComponent(centerPositionPanel_2, GroupLayout.PREFERRED_SIZE, 66,
										GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(ComponentPlacement.RELATED)
								.addComponent(centerPositionPanel_3, GroupLayout.PREFERRED_SIZE, 66,
										GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(ComponentPlacement.RELATED)
								.addComponent(centerPositionPanel_4, GroupLayout.PREFERRED_SIZE, 66,
										GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(ComponentPlacement.RELATED)
								.addComponent(scoreBoardPanel, GroupLayout.PREFERRED_SIZE, 66,
										GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(ComponentPlacement.UNRELATED)
								.addComponent(btnFinishButton, GroupLayout.PREFERRED_SIZE, 31,
										GroupLayout.PREFERRED_SIZE)
		...
		JLabel resultLabel = new JLabel(
				environment.getGame().printResult(Integer.valueOf(playerScore), Integer.valueOf(opponentScore)));
				...
				gl_teamNamespanel.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_teamNamespanel.createSequentialGroup()
								...
								.addGroup(gl_teamNamespanel.createParallelGroup(Alignment.LEADING)
										.addGroup(gl_teamNamespanel.createSequentialGroup()
												.addPreferredGap(ComponentPlacement.RELATED)
												.addComponent(teamNameLabel, GroupLayout.PREFERRED_SIZE, 191,
														GroupLayout.PREFERRED_SIZE))
										.addGroup(gl_teamNamespanel.createSequentialGroup()
												.addGap(90)
										...
										.addGroup(gl_teamNamespanel.createSequentialGroup()
												.addPreferredGap(ComponentPlacement.UNRELATED)
												.addComponent(opponentTeamNameLabel, GroupLayout.PREFERRED_SIZE, 177,
														GroupLayout.PREFERRED_SIZE)))
								.addPreferredGap(ComponentPlacement.RELATED, 51, Short.MAX_VALUE)
								.addComponent(weekNumberpanel, GroupLayout.PREFERRED_SIZE, 61,
										GroupLayout.PREFERRED_SIZE)));
				...
				gl_weekNumberpanel.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_weekNumberpanel.createSequentialGroup()
								.addGroup(gl_weekNumberpanel.createParallelGroup(Alignment.LEADING)
										.addGroup(gl_weekNumberpanel.createSequentialGroup()
												.addGap(4)
												.addComponent(lblNewLabel_2, GroupLayout.PREFERRED_SIZE, 55,
														GroupLayout.PREFERRED_SIZE))
										.addGroup(gl_weekNumberpanel.createSequentialGroup()
												.addGap(7)
												.addComponent(weekNumberLabel, GroupLayout.PREFERRED_SIZE, 55,
														GroupLayout.PREFERRED_SIZE))
										.addGroup(gl_weekNumberpanel.createSequentialGroup()
												.addGap(6)
												.addComponent(lblNewLabel_1, GroupLayout.PREFERRED_SIZE, 52,
														GroupLayout.PREFERRED_SIZE)))
								.addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
		gl_weekNumberpanel.setVerticalGroup(
				gl_weekNumberpanel.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_weekNumberpanel.createSequentialGroup()
								...
								.addGap(2)
								.addComponent(weekNumberLabel, GroupLayout.PREFERRED_SIZE, 15,
										GroupLayout.PREFERRED_SIZE)
				...
				gl_centerPositionPanel.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_centerPositionPanel.createSequentialGroup()
								.addGroup(gl_centerPositionPanel.createParallelGroup(Alignment.TRAILING, false)
										.addGroup(gl_centerPositionPanel.createSequentialGroup()
												.addComponent(centerVersusPanel, GroupLayout.PREFERRED_SIZE, 346,
														GroupLayout.PREFERRED_SIZE)
												.addGap(8))
										.addGroup(gl_centerPositionPanel.createSequentialGroup()
						...
						.addGroup(gl_centerPositionPanel.createSequentialGroup()
								.addGroup(gl_centerPositionPanel.createParallelGroup(Alignment.LEADING)
										.addGroup(gl_centerPositionPanel.createSequentialGroup()
												...
												.addComponent(centerLabel)
												.addPreferredGap(ComponentPlacement.RELATED)
												.addComponent(centerVersusPanel, GroupLayout.PREFERRED_SIZE, 38,
														Short.MAX_VALUE))
										.addComponent(centerScoreLabel, GroupLayout.PREFERRED_SIZE, 64,
												GroupLayout.PREFERRED_SIZE))
								.addContainerGap()));
		...
		gl_centerVersusPanel.setHorizontalGroup(
				gl_centerVersusPanel.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_centerVersusPanel.createSequentialGroup()
								.addComponent(playerCenterLabel, GroupLayout.PREFERRED_SIZE, 149,
										GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(ComponentPlacement.UNRELATED)
								.addComponent(centerVersusLabel, GroupLayout.PREFERRED_SIZE, 38,
										GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(ComponentPlacement.UNRELATED)
