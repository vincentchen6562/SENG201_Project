...
public class Inventory {
    ...
    public void spend(int amount) { //a method to decrease the amount of money available based on the player's purchase decisions
        bank -= amount;
    }

    public void surplus(int amount) { //a method to increase the player's money pool based on the matches won
        bank += amount;
    }
